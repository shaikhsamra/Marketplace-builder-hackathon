...
const Hero = () => {
  return (
    <main className="w-full h-full md:h-auto flex flex-col md:flex-row justify-between  items-start bg-[#F2F0F1] max-w-screen-2xl m-auto">
        {/* Left  */}
      <div className="w-full md:w-[500px] md:mt-24 md:ml-28 mt-3 pl-3 ">
...
className="w-[60px] md:w-[100px] absolute md:top-[50px] top-[40px] right-[20px] md:right-[30] animate-spin"></Image>

<Image src={"/hero/star1.png"} width={200} height={200} alt="Star Image"
 className="w-[40px] md:w-[60px] absolute top-[150px] left-[5px] md:top-[220px] md:left-[-30] animate-spin"></Image>
