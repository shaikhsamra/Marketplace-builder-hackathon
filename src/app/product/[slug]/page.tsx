    ...
    <div className="max-w-screen-2xl mx-auto bg-gray-50 px-4 py-8">
      ...
      <div className="w-[160px] h-[130px] mt-2 rounded-2xl">
        ...
        <div className="flex flex-col gap-6 mt-2">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold font-integral">{name}</h1>
          ...
          {/* Description */}
          <p className="text-md text-gray-700 font-satoshi -mt-2">{description}</p>
          ...
          <div className="space-y-2 -mt-2">
            {colors && colors.length > 0 && (
              <div>
                <h3 className="font-semibold font-integral">Choose Colors:</h3>
          ...
          <div className="flex gap-5 -mt-4">
            ...
            <button className="mt-6 bg-black text-white py-3 px-16 md:px-[150px] rounded-full font-satoshi">
              Add to Cart
            </button>
          </div>
        </div>
