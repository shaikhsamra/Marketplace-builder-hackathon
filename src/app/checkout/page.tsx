...
// npm Install @stripe/stripe-js & npm i @stripe/react-stripe-js
...
export default function CheckoutPage() {
  ...
  return (
    <div style={{ maxWidth: 400, margin: "0 auto" }} >
      <h1 className="text-2xl md:text-5xl font-extrabold p-2 m-2 font-integral">Payment Method</h1>
...
function PaymentForm() {
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <PaymentElement />
      <button type="submit" 
      className="p-2 px-10 mt-2 mb-2 bg-black text-white border-2"
